...
public class VistaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtPassword.setText("u29298nf8");

        txtUsuario.setText("mramirez");
    ...
    private void login() {
        ...
        if (usuario != null) {
            if(usuario.getRol() == Rol.Compañia) {
                ...
                dispose();
                new VistaIngresoFrecuencia(usuario).setVisible(true);
            }
            else if(usuario.getRol() == Rol.Aeropuerto) {
                controladorSistema.login(nombre, password);
                dispose();
                VistaMonitoreo vistaMonitoreo = new VistaMonitoreo(usuario);
                vistaMonitoreo.setVisible(true);
                new VistaAprobarFrecuencia(usuario, vistaMonitoreo).setVisible(true);
            }
        } else {
